...
- **Codes declared** by the module: IRS Concrete Bridge Code, IS 456, IR Bridge Rules (track surcharge). A citation outside this set on a retaining-wall output is a defect.
