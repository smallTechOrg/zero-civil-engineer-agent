...
SECTION_TITLES = {
    ...
    "loading": "Loading (Dead + 25t Live Load, CDA)",
    "section_analysis": "Section Properties, Stresses & Deflection",
    "section_checks": "Strength & Serviceability Checks (IRS Steel Bridge Code / IS 800)",
}
...
def compose_calc_sheet(
    *,
    ...
    design_basis.extend([
        ...
        _line("Deck type", params.deck_type, "", CITATION_PARAMETER, None),
        _line("Loading standard", params.loading_standard.value, "", CITATION_PARAMETER, None),
        _line("Number of girders", params.number_of_girders, "", CITATION_PARAMETER, None),
        _line(
            "Proportioned girder",
            f"span {geometry.span_mm:g} mm, overall depth {geometry.overall_depth_mm:g} mm, "
