"""Type-specific stability summary for the substructure Stability panel.

Shape (REUSES the frontend's existing stability panel + the api snapshot — the
same keys the retaining wall emits):
